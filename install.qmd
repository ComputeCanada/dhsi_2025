...
and then press Tab to autocomplete the full file name. The name of the file you just downloaded should appear.
...
Once you are in "Anaconda Prompt" (Windows), "Terminal" (MacOS), type:

```{.bash}
jupyter lab
```

and press "Enter". If you see a window similar to this screenshot in your browser, it means you are good to go:
